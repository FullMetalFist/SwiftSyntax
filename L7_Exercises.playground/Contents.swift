...
// if EspressoDrink were implemented as a class, we would have steamedMilk = .Splash for macchiato & espresso
//: __Problem 2__
//:
//: __2a.__
...
struct Cookie {
    ...
    var delicious: Bool {
        get {
            if flavor == "Chocolate Chip" || (minutesSinceRemovalFromOven < 30) {
                return true
            }
            else {
                return false
