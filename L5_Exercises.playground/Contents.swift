...
var unitedWord = ""
func combineLastCharacters(arrayOfStrings:[String]) -> String {
    var comboWord: String?
    for word in arrayOfStrings {
        comboWord?.append(word.characters.first!)
    }
    return comboWord!
}
//unitedWord = combineLastCharacters(nonsenseArray)
print(unitedWord)
//: __Problem 3__
//:
